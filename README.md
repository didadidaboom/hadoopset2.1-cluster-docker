...
```
sudo docker pull didadidaboom/hadoopset:2.1
...
```
git clone https://github.com/didadidaboom/hadoopset2.1-cluster-docker.git
```
...
```
cd hadoopset2.1-cluster-docker
...
1. added virtualenv for the cluster
